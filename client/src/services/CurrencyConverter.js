...
const RAPID_KEY = 'fb6539079dmsh5909eedae41e683p1d4e3cjsn4b2a1e246a5c'

async function convertCurrencies(from, to, amount) {
    let response
    try {
        const options = {
            method: 'GET',
            ...
            headers: {
              'X-RapidAPI-Key': 'fb6539079dmsh5909eedae41e683p1d4e3cjsn4b2a1e246a5c',
