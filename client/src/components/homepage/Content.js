...
function Content() {
  ...
  return (
    <div> <div className="container-fluid p-0 top-0 start-0 w-100 h-100">
    <div className=" header-carousel position-relative top-0 start-0 w-100 h-100">
        ...
        <img className="img-fluid w-100 h-100" src={img1} alt=""/ >
            <div className="position-absolute top-0 start-0 w-100 h-100 d-flex align-items-center"style={v1} >
                <div className="container">
                    <div className="row justify-content-start">
                        <div className="col-sm-10 col-lg-8">
                            ...
                            <Link href="" className="btn btn-primary py-md-3 px-md-5 me-3 animated slideInLeft">Join Now</Link>
                            <h1 className="display-3 text-white animated slideInDown">Welcome</h1>
